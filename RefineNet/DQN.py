...
STEPS_PER_EPOCH = 25000   #100000 // UPDATE_FREQ  # each epoch is 100k played frames
TARGET_NET_UPDATE = 2500 #10000 // UPDATE_FREQ # update target network every 10k steps
EVAL_EPISODE = 1
...
def get_player(viz=False, train=False):
    ...
    SEG_checkpoints_paths = [
        'LightVnet/checkpoints/0_0.5/checkpoint_101250.pth.tar',
        'LightVnet/checkpoints/1_0.75_r/checkpoint_163750.pth.tar',
        'LightVnet/checkpoints/2_1.0_r/checkpoint_276250.pth.tar',
        'LightVnet/checkpoints/3_1.0_r/checkpoint_1232500.pth.tar'
    ]
    ...
    def _get_DQN_prediction(self, image):
        ...
        with argscope(Conv2D, activation=lambda x: PReLU('prelu', x), use_bias=True):
            l = (LinearWrap(image)
                 ...
                 .MaxPooling('pool2', 2)
                 .Conv2D('conv3', out_channel=64, kernel_shape=3, stride=2)
                 .Conv2D('conv4', out_channel=64, kernel_shape=3, stride=2)

                 .FullyConnected('fc0', 128)
                 .FullyConnected('fc1', 64)
